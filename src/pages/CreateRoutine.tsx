    ...
    >
      ...
      >
        ...
        <button
          ...
          className={cn(
            "px-4 py-1.5 rounded-lg font-bold transition-all active:scale-95",
              ...
              >
                ...
                <div className="w-full">
                          ...
                          <div className="flex-1 px-2">
                            <input
                              ...
                              className={cn(
                                ...
                                isDark
                                  ? "text-white focus:bg-zinc-800"
                                  : "text-zinc-900 focus:bg-zinc-200",
                              )}
                            />
                          </div>
                          <div className="flex-1 px-2">
                  ...
                  <button
                    ...
                    className={cn(
                      "w-full mt-4 py-3.5 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors",
                      isDark
